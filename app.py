...
_webhook_attempted = False

def ensure_webhook():
    global _webhook_ready, _webhook_attempted
    if _webhook_ready or _webhook_attempted or not BASE_URL:
        return
    ...
    try:
        ...
        if r.ok:
            ...
            log.warning('setWebhook rejected: %s %s', r.status_code, r.text[:200])
